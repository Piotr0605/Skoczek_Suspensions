...
import { APP_NAME, ADDRESS, PHONE, EMAIL, PRICING_DATA, REGULATION_POINTS } from './constants';
...
import { 
  ...
  CheckCircle, Send, Cookie, ChevronDown, ChevronUp, Lock
} from 'lucide-react';

// --- Logo Component (Single Coil Shock - Ohlins Style) ---
...
const App: React.FC = () => {
  const [view, setView] = useState<'HOME' | 'DASHBOARD' | 'FORM' | 'REGULATIONS' | 'CONTACT' | 'ADMIN'>('HOME');
  ...
  const NavLink = ({ label, target }: { label: string, target: 'HOME' | 'DASHBOARD' | 'FORM' | 'REGULATIONS' | 'CONTACT' | 'ADMIN' }) => (
    <button 
  ...
  // Reusable Map Component with Consent Check
  const MapComponent = () => {
    if (!cookieConsent) {
        return (
    ...
    <div className="min-h-screen flex flex-col font-sans bg-white text-gray-900">
          ...
          <>
            ...
            <section className="relative py-20 lg:py-32 bg-white overflow-hidden">
               ...
               <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
                  ...
                  {/* Visual balance element for desktop */}
               ...
               <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
                  <div className="flex flex-col items-center md:items-start text-center md:text-left gap-3 group pl-4 md:pl-0">
                     ...
                     <div>
                       ...
                       <p className="text-xs text-gray-500 mt-1">3 miesiące na usługi</p>
                     </div>
                  </div>
              ...
              <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                   ...
                   <div className="space-y-8">
                     ...
                     {/* Interactive Email Link (Leads to Contact View) */}
                 ...
                 <div className="bg-white p-8 md:p-12 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div className="prose max-w-none">
                       ...
                       <div className="space-y-6">
                          {REGULATION_POINTS.map((point, idx) => (
                             <div key={idx} className="flex gap-4 items-start p-4 bg-gray-50 rounded border border-gray-100">
                                <span className="font-black text-skoczek-primary text-lg select-none">0{idx + 1}.</span>
      ...
      <footer className="bg-white border-t border-gray-200 py-12">
        ...
        <div className="max-w-7xl mx-auto px-4 mt-8 pt-8 border-t border-gray-100 text-center text-gray-400 text-xs">
           &copy; {new Date().getFullYear()} Skoczek Suspensions. Realizacja inspirowana designem Galerii Rowerowej.
        </div>
      </footer>
