...
import { REGULATION_POINTS } from '../constants';
...
const ServiceForm: React.FC<ServiceFormProps> = ({ user, onSuccess, onRequestLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Wystąpił błąd podczas wysyłania zgłoszenia. Spróbuj ponownie.");
    } finally {
    ...
    <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-xl relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-50 p-5 rounded border border-gray-200 text-sm">
          <h4 className="text-black font-bold uppercase text-xs mb-3">Regulamin Serwisu</h4>
          <ul className="list-disc list-inside space-y-1 mb-4 h-32 overflow-y-auto custom-scrollbar text-gray-600 pr-2">
